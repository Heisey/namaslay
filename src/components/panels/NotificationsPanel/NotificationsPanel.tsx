  ...
  return (
    <div className="NotificationsPanel">
      ...
      <div className="NotificationsPanel__content">
        ...
        <p className="Notificationpel__line">05/31: Welcome Our New Teacher: Vera Lynn</p>
        <p className="Notificationpel__line">05/21: Guided Meditation by Tara Brach: June 12</p>
      </div>
